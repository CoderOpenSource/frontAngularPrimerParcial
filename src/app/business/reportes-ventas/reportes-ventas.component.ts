...
export class ReportesVentasComponent implements OnInit {
  ...
  buscarClientePorTexto() {
    ...
    this.timeout = setTimeout(() => {
      this.http.get<Cliente[]>('http://127.0.0.1:8000/api/usuarios/', {
  ...
  generarReporte() {
    ...
    const endpoint = this.formato === 'pdf'
      ? 'http://127.0.0.1:8000/api/reportes/ventas-por-fecha/pdf/'
      : 'http://127.0.0.1:8000/api/reportes/ventas-por-fecha/excel/';
